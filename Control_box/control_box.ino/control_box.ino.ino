...
long debouncing_time = 250;			// I think it's in milisec. If interrupt is triggering more than once increase this value
...
void loop() 
{
  ...
  {
    attachInterrupt(digitalPinToInterrupt(AUP), aUpDebounce, RISING); // use of digitalPinToInterrupt is safer. debounce is the name of the function called when triggered.
